...
export class Terminal extends Component {
  constructor() {
    ...
    this.child_directories = {
      ...
      projects: [
        "Joiner9patel-personal-portfolio",
        "synonyms-list-react",
    ...
    return (
      <React.Fragment key={id}>
        <div className="flex w-full h-5">
          <div className="flex">
            <div className=" text-ubt-green">Joiner@Dell</div>
  ...
  handleCommands = (command, rowId) => {
    ...
    switch (main) {
      ...
      case "pwd":
        ...
        result = str.replace("~", "/home/Joiner");
        break;
      case "code":
        if (words[0] === "." || words.length === 0) {
          ...
          result =
            "Command '" +
            main +
            "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-Joiner, todoist, trash, settings, sendmsg]";
        }
        break;
      case "echo":
      ...
      case "about-Joiner":
        if (words[0] === "." || words.length === 0) {
          this.props.openApp("about-Joiner");
        } else {
          result =
            "Command '" +
            main +
